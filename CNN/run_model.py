...
def parse_args():
    ...
    parser.add_argument('--datalist', type=str, default='./data_list.txt', help='training datalist')
    ...
    parser.add_argument('--epoch', help='training epoch number', type=int, default=10000)
    parser.add_argument('--lr', type=float, default=1e-4, dest='learning_rate', help='initial learning rate')
    parser.add_argument('--gpu', dest='gpu_id', type=str, default='0', help='use gpu or cpu')  # -1 for CPU
    ...
    parser.add_argument('--input_path', type=str, default=PATH+'test/blur',
                        help='input path for testing images')
    parser.add_argument('--output_path', type=str, default=PATH+'test/results',
